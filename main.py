...
TOKEN = '1439819479:AAG__iqP09cfS40F74dRB62Tawqnhx3dQ_o'

THREADS_LIMIT = 1300

chat_ids_file = 'chat_ids.txt'

ADMIN_CHAT_ID = 903691668

group_id = -1001162534283
...
def handle_message_received(message):
  ...
  if user_status == 'member' or user_status == 'administrator' or user_status == 'creator':
   ...
   if text == "Добавить партнер" and chat_id == ADMIN_CHAT_ID:
    ...
    bot.send_message(chat_id, 'Владелец бота: @Denu \nПо вопросам сотрудничества обращаться в ЛС сюда @Denu \nБот работает пока что только на Россию и Украину')

   elif text == '🔥💣БОМБЕР':
    bot.send_message(chat_id, 'Автор не берьот за ваши действия: Введите номер в формате:\n🇷🇺 79xxxxxxxxx\n🇺🇦 380xxxxxxxxx')
